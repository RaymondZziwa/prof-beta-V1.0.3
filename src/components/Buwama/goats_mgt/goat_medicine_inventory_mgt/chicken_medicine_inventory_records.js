...
const BuwamaChickenMedicineInventoryRecords = () => {
    ...
    const fetchShopInventoryRecords = async () => {
        let res = await axios.post('http://82.180.136.230:3005/fetchbuwamachickenmedicinesinventoryrecords',{
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Buwama Chicken Inventory Restocking Records</h1>
...
export default BuwamaChickenMedicineInventoryRecords