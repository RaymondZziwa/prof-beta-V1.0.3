...
const BuwamaStartBatchFromMotherGarden = () => {
    ...
    const submitRequestHandler = async event => {
        event.preventDefault()
        let res = await axios.post('http://82.180.136.230:3005/buwamarequestseeds', {
            batchNo: `B-${Math.floor(Math.random() * 180000)}`,
...
export default BuwamaStartBatchFromMotherGarden