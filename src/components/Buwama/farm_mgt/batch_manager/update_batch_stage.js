...
const UpdateBatchStatus = () => {
    ...
    const fetchBatchData = async event => {
        ...
        let res = await axios.post('http://82.180.136.230:3005/buwamafetchdatafromfarm',{
    ...
    const updateProcess = async event => {
        ...
        itemsPostRequested.map((item) => {
         ...
         let res = await axios.post('http://82.180.136.230:3005/buwamasavebatchstage',{
             token: localStorage.getItem('token'),
             batchNumber: batchNo,
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input
                                                                            ...
                                                                            value={itemrecord.itemNewQuantity}
                                                                            onChange={event => { handlePostInput(index, event) }}
                                                                            required />
                                                                    </div>
                                                                </td>
