...
const BuwamaChickenMedicineRestockingForm = () => {
    ...
    const saveRestockData = async event => {
        event.preventDefault()
         let res = await axios.post('http://82.180.136.230:3005/buwamasavechickenmedicinerestockdata',{
            token:localStorage.getItem('token'),
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Buwama Chicken Medicine Restocking Form</h1>
...
export default BuwamaChickenMedicineRestockingForm