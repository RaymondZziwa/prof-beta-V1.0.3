...
const BuwamaManageCattleMilkProduction = () => {
        ...
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                ...
                <div className="form-floating mb-3">
                    ...
                    <label htmlFor="floatingInput">Total Milk (L) Collected</label>
                </div><br></br>
                <div className="form-floating mb-3">
                ...
                <h1 style={{textAlign:'center'}}>Batch Milk Collection Records</h1>
...
export default BuwamaManageCattleMilkProduction
