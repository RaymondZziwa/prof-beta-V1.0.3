...
const BuwamaCattleMgtReport = () => {
    ...
    const fetchHealthData = async () => {
        const res = await axios.post('http://82.180.136.230:3005/buwamafetchallbatchhealthdata', {
            token: localStorage.getItem("token")
        })
        if(Array.isArray(res.data)){
    ...
    const fetchMortalityData = async () => {
        const res = await axios.post('http://82.180.136.230:3005/buwamafetchallbatchmortalitydata', {
            token: localStorage.getItem("token")
        })
        if(Array.isArray(res.data)){
    ...
    return(
        ...
        <Row>
            <h1 style={{textAlign:'center', color:'black',marginTop:'60px'}}>Buwama Cattle Farm Metrics Report <span style={{float:'right',marginRight:'10px'}}><ReportPrintingButton /></span></h1>
        ...
        <Row style={{marginTop:'50px'}}>
            ...
            <Col sm='12' md='6' lg='6' xl='6'>
                <h2 style={{textAlign:'center', color:'black',marginTop:'100px'}}>Milk Production Analysis</h2>
        ...
        <Row style={{marginTop:'50px'}}>
            ...
            <Col sm='12' md='6' lg='6' xl='6'>
                <h2 style={{textAlign:'center', color:'black',marginTop:'100px'}}>Cattle Mortality Analysis</h2>
...
export default BuwamaCattleMgtReport