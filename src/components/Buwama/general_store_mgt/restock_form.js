...
const BuwamaGeneralStoreRestockForm = () => {
    ...
    return(
        ...
        <div className="col align-self-center" style={{marginTop:'60px'}}>
            <h1 style={{textAlign:'center'}}>Buwama General Store Restocking Form</h1>
            ...
            <select class="form-select" aria-label="Default select example" style={{ height: "60px", color: "#8CA6FE;" }} onChange={sourceInput} required>
                ...
                <div className="mb-3">
                <textarea type="text" className="form-control" rows="6" id="floatingInput" placeholder="Source Information" style={{ color: "#8CA6FE", height: '130px', width: '300px' , marginTop:'10px'}} onChange={externalSourceInfoInput} />
                </div>
            <div className="form-floating mb-3">
...
export default BuwamaGeneralStoreRestockForm
