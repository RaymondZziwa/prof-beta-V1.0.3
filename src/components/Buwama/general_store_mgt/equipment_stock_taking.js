...
const BuwamaEquipmentStockTaking = () => {
    ...
    const fetchAllStoreRecords =  async () => {
        ...
        if(Array.isArray(res.data)){
            const equipmentStokeTaking = res.data.filter((data)=>
                data.category === 'EQUIPMENT'
            )
            setData(equipmentStokeTaking)
        }
    }
    ...
    return(   
        ...
        <div className="col align-self-center" style={{marginTop:'60px'}}>
            <h1 style={{textAlign:'center'}}>Buwama Farm Equipment Stock Taking</h1>
            <Row>
 ...
 export default BuwamaEquipmentStockTaking