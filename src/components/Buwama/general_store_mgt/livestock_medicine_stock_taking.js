...
const BuwamaLivestockMedicineStockTaking = () => {
    ...
    const fetchAllStoreRecords =  async () => {
        ...
        if(Array.isArray(res.data)){
            const MedicineStokeTaking = res.data.filter((data)=>
                data.category === 'MEDICINE'
            )
            setData(MedicineStokeTaking)
    ...
    return(
        ...
        <div className="col align-self-center" style={{marginTop:'60px'}}>
            <h1 style={{textAlign:'center'}}>Buwama Livestock Medicine Stock Taking</h1>
            <Row>
 ...
 export default BuwamaLivestockMedicineStockTaking