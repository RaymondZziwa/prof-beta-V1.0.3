...
const BuwamaRegisterNewChickenBatch = () => {
    ...
    const saveChickenBatchData = async (event) => {
        let res = await axios.post('http://82.180.136.230:3005/buwamasavenewchickenbatchdata',{
...
export default BuwamaRegisterNewChickenBatch