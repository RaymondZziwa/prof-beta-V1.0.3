...
const BuwamaChickenFeedsInventoryRecords = () => {
    ...
    const fetchShopInventoryRecords = async () => {
        let res = await axios.post('http://82.180.136.230:3005/fetchbuwamachickenfeedsinventoryrecords',{
...
export default BuwamaChickenFeedsInventoryRecords