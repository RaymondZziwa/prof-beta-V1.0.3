...
const EquatorialProjectsMonthlyReport = () => {
        ...
        <div style={{color:'black'}}>
            <Row>
                ...
                <Col sm='12' md='10' lg='10' xl='10'>
                    <h1 style={{textAlign:'center', color:'black',marginTop:'60px'}}>Equatorial Projects Monthly Report <span style={{float:'right',marginRight:'10px'}}><ReportPrintingButton /></span></h1>
...
export default EquatorialProjectsMonthlyReport