...
const EquatorialProjectsDailyReport = () => {
    ...
    useEffect(() => {
        const fetchSalesData = async () => {
          let res = await axios.post('http://82.180.136.230:3005/fetchallequatorialprojectsrecords', {
            token: localStorage.getItem('token')
          });
      
          if (Array.isArray(res.data)) {
            console.log('slss',res.data)
            setIsLoading(false);
        ...
        <div style={{color:'black'}}>
            <Row>
                ...
                <Col sm='12' md='10' lg='10' xl='10'>
                    <h1 style={{textAlign:'center', color:'black',marginTop:'60px'}}>Equatorial Projects Department Daily Report <span style={{float:'right',marginRight:'10px'}}><ReportPrintingButton /></span></h1>
                    ...
                    <h2 style={{textAlign:'center', marginTop:'60px',color:'black'}}>Daily Income Report</h2>
...
export default EquatorialProjectsDailyReport