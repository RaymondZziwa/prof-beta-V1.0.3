...
const EquatorialProjectsDepartmentOutgoingForm = () => {
    ...
    const saveRestockData = async event => {
        event.preventDefault()
         let res = await axios.post('http://82.180.136.230:3005/saveequatorialprojectsdepartmentstockdata',{
            token:localStorage.getItem('token'),
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Equatorial Projects Inventory Outgoing Form</h1>
...
export default EquatorialProjectsDepartmentOutgoingForm