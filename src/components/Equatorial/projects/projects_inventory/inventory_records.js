...
const EquatorialProjectsInventoryRecords = () => {
    ...
    const fetchShopInventoryRecords = async () => {
        let res = await axios.post('http://82.180.136.230:3005/fetchequatorialprojectsinventoryrecords',{
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Equatorial Projects Department Inventory Restocking Records</h1>
                ...
                <h1 style={{textAlign:'center'}}>Equatorial Projects Department Inventory Outgoing Records</h1>
                <table className="table table-light">
                        <thead>
                            <tr>
                                <th scope="col">Date</th>
...
export default EquatorialProjectsInventoryRecords