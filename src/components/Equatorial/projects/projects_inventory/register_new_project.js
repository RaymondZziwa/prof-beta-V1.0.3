...
const EquatorialNewProjectRegistration = () => {
    ...
    const registerItemHandler = async event => {
        event.preventDefault()
        let res = await axios.post('http://82.180.136.230:3005/registernewprojectitem', {
            token: localStorage.getItem('token'),
                ...
                <div className="col align-self-center">
                    <Form style={{ justifyContent: 'center', marginTop: '20px' }}>
                        <div className="mb-3">
                            ...
                            <span><button className="btn btn-outline-primary" onClick={registerItemHandler}>Register Project</button></span>
                        </div>
                    </Form>
                </div>
            </Col>
...
export default EquatorialNewProjectRegistration