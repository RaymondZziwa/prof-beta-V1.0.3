...
const EquatorialProjectsDepartmentStockTaking = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          if (isStockDataLoading) {
            const res = await axios.post('http://82.180.136.230:3005/fetchequatorialprojectsdepartmentstock', {
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Equatorial Projects Department Stock Taking</h1>
                <Row>
...
export default EquatorialProjectsDepartmentStockTaking