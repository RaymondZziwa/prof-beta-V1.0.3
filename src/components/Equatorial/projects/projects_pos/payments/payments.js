    ...
    render() {
      ...
      return (
        <div style={{color:'black',padding:'20px'}}>
          <h1 style={{textAlign:'center'}}> <img src={Logo} alt="receipt-logo" style={{margin:'auto'}}  height='80px'/><br></br>Prof-bioresearch {localStorage.getItem('branch')} projects receipt</h1>
...
const PaymentModule = ({ servicesList, items, total }) => {
    ...
    const handleSubmit = async (event) => {
       ...
       let res = await axios.post('http://82.180.136.230:3005/equatorialprojectscartcheckout',{
