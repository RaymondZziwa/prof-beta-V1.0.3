...
const EquatorialProjectsExternalReceiptsPOS = () => {
    ...
    return(
        ...
        <div className="col align-self-center" style={{marginTop:'40px'}}>
            <h1 style={{textAlign:'center'}}>Equatorial Projects Point Of Sale</h1>
            <Row>
...
export default EquatorialProjectsExternalReceiptsPOS