...
const EquatorialProjectsCreateExternalReceipts = () => {
    ...
    return(
        ...
        <div className="col align-self-center" style={{marginTop:'40px'}}>
            <h1 style={{textAlign:'center'}}>Create External Receipt</h1>
            <Row>
...
export default EquatorialProjectsCreateExternalReceipts