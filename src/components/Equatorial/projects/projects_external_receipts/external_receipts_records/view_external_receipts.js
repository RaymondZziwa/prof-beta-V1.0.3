...
const IssuedEquatorialProjectsExternalReceiptsRecords = () => {
        ...
        <Col sm='12' md='10' lg='10' xl='10'>
          ...
          <div style={{ textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '10px' }}>
            <div className="form-floating mb-3">
              <input className="form-control" id="floatingInput" placeholder="Order-Id" style={{ color: "#8CA6FE" }} onChange={receiptNumberHandler} required />
...
export default IssuedEquatorialProjectsExternalReceiptsRecords;
