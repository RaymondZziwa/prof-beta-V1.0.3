...
const EquatorialGeneralStoreStockTaking = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          if (isStockDataLoading) {
            const res = await axios.post('http://82.180.136.230:3005/fetchaequatorialgeneralstorestock', {
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Equatorial General Store Stock Taking</h1>
                <Row>
...
export default EquatorialGeneralStoreStockTaking