...
const EquatorialProjectsDailyIncomeSubmission = () => {
    ...
    const fetchAllSubmissionRecords = async () => {
        let res = await axios.post('http://82.180.136.230:3005/fetchallprojectsincomesubmissionrecords',{
    ...
    const onIncomeSubmission = async event => {
        ...
        let res = await axios.post('http://82.180.136.230:3005/submitprojectsincome',{
            token: localStorage.getItem('token'),
            date: new Date().toLocaleDateString('en-GB', options),
            amount: amount,
            deliveredTo: localStorage.getItem('username'),
...
return (
    ...
    <div className="col align-self-center" style={{marginTop:'40px'}}>
        <h1 style={{textAlign:'center'}}>Daily Projects Income Submission</h1>
        <Row>
            <Col sm='12' md='4' lg='4' xl='4'>
                ...
                <Form onSubmit={onIncomeSubmission}>
                    ...
                    <div className="form-floating mb-3">
                        <input type="number" className="form-control" rows="6" id="floatingInput" placeholder="johndoe" style={{ color: "#8CA6FE" }} onChange={(e)=> setAmount(e.target.value)}  min='0' />
                        <label for="floatingInput">Amount Earned (UGX) </label>
                    </div>
                    <div className="form-floating mb-3">
                    ...
                    <div className="form-floating mb-3">
                        <input type="text" className="form-control" rows="6" id="floatingInput" placeholder="johndoe" style={{ color: "#8CA6FE" }} value={localStorage.getItem('username')} min='0' readOnly/>
            ...
            <Col sm='12' md='8' lg='8' xl='8'>
                <h3 style={{textAlign:'center'}}>View Records</h3>
...
export default EquatorialProjectsDailyIncomeSubmission