...
class PrintableContent extends React.Component {
  render() {
    const { week, month, year, tsm ,tsmr ,tsmnr ,tea ,teap ,teanp, tni, tvisa, tprofmm, tmtn, tairtel ,tmi } = this.props;
    ...
    return (
      <div style={{color:'black',padding:'20px'}}>
        ...
        <p>Report For Week, Month, Year: Week {week} / {month} / {year}</p>
        <p style={{textAlign:'center', fontSize:'20px'}}>WEEKLY PROFIT/LOSS ANALYSIS REPORT</p>
      ...
      useEffect(() => {
        const fetchExpensesData = async () => {
          ...
          if (Array.isArray(res.data)) {
            ...
            setIsLoading(false);
            setExpensesData(receivedMassageData);
          }
        }
        ...
        <div style={{backgroundColor:'#E9E9E9', color:'black'}}>
            <Row>
                ...
                <Col sm='12' md='10' lg='10' xl='10'>
                    <h1 style={{textAlign:'center', color:'black',marginTop:'60px'}}>Equatorial Shop Weekly Report <span style={{float:'right',marginRight:'10px'}}>
                      <ReactToPrint
                            trigger={() => (
                          ...
                          <div className="print-content">
                              <PrintableContent ref={componentRef} week={selectedWeek} month={selectedMonth} year={selectedYear} tsm={totalAmount} tsmr={totalAmountPaid} tsmnr={balance} tea={totalExpenditureAmount} teap={totalExpenditureAmountPaid} teanp={expenditureBalance}  tni={paymentMethodTotals.Cash-expensePaymentMethodTotals.Cash} tmtn={paymentMethodTotals.MTNMoMo-expensePaymentMethodTotals.MTNMoMo} tairtel={paymentMethodTotals.AirtelMoney-expensePaymentMethodTotals.AirtelMoney} tprofmm={paymentMethodTotals.ProfMM-expensePaymentMethodTotals.ProfMM} tvisa={paymentMethodTotals.Visa-expensePaymentMethodTotals.Visa} tmi={totalMassageAmount}/>
                          </div>
                          <style>
                              {`
                              .print-content {
