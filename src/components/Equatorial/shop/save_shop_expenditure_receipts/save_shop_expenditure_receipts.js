...
const SaveEquatorialShopExpenditureReceipts = () => {
    ...
    const saveReceiptDataHandler = async (event) => {
        ...
        try {
          const res = await axios.post('http://82.180.136.230:3005/saveequatorialexpensereceipt', formData, {
            headers: {
...
export default SaveEquatorialShopExpenditureReceipts