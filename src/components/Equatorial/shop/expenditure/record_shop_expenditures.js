...
const RecordEquatorialShopExpenditure = () => {
    ...
    const fetchExpenseData = async () => {
        let res = await axios.post('http://82.180.136.230:3005/fetchequatorialexpendituredata',{
             token: localStorage.getItem('token'),
...
export default RecordEquatorialShopExpenditure