...
const EquatorialExpenseReceiptViewer = () => {
  ...
  useEffect(() => {
    ...
    const fetchReceipts = async () => {
      try {
        const response = await axios.post('http://82.180.136.230:3005/fetchequatorialexpensesreceipts', {
...
export default EquatorialExpenseReceiptViewer;
