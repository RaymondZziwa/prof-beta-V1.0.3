...
const EquatorialMassageDepartmentServicesRecords = () => {
    ...
    useEffect(() => {
        const fetchSalesData = async () => {
          let res = await axios.post('http://82.180.136.230:3005/fetchallequatorialmassageservicesrecords', {
        ...
        <>
            <div className='container-fluid'>
                <Row>
                    ...
                    <h2 style={{textAlign:'center', marginTop:'60px'}}>Equatorial Massage Services Records</h2>
...
export default EquatorialMassageDepartmentServicesRecords