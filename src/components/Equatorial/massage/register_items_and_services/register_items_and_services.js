...
const RegisterItemsAndServices = () => {
                ...
                <div className="col align-self-center">
                    <Form style={{ justifyContent: 'center', marginTop: '20px' }}>
                        <div className="mb-3">
                            ...
                            <span><button className="btn btn-outline-primary" onClick={registerItemHandler}>Add Item</button></span>
                        </div>
                    </Form>
                </div>
            </Col>
...
export default RegisterItemsAndServices