...
import '../../labelling/stock_taking/stocktaking.css'

const EquatorialMassageDepartmentStockTaking = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          if (isStockDataLoading) {
            const res = await axios.post('http://82.180.136.230:3005/fetchequatorialmassagedepartmentstock', {
    ...
    return(
      ...
      <Row className='row justify-content-center' style={{marginTop:'60px'}}>
          <Col className='col-8'>
              <h1 style={{textAlign:'center'}}>Equatorial Massage Department Stock Taking</h1>
...
export default EquatorialMassageDepartmentStockTaking