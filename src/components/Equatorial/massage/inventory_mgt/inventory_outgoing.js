...
const EquatorialMassageDepartmentOutgoingForm = () => {
    ...
    return(
        <Row>
            ...
            <div className="col align-self-center" style={{marginTop:'60px'}}>
                <h1 style={{textAlign:'center'}}>Equatorial Massage Inventory Outgoing Form</h1>
...
export default EquatorialMassageDepartmentOutgoingForm