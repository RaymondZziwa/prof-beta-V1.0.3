        ...
        <div style={{backgroundColor:'#E9E9E9', color:'black'}}>
            <Row>
                ...
                <Col sm='12' md='10' lg='10' xl='10'>
                    <h1 style={{textAlign:'center', color:'black',marginTop:'60px'}}>Masanafu Shop Weekly Report <span style={{float:'right',marginRight:'10px'}}>
                        <ReactToPrint
                            trigger={() => (
